...
[![AppVeyor build status](https://ci.appveyor.com/api/projects/status/github/UBESP-DCTV/clumpr?branch=master&svg=true)](https://ci.appveyor.com/project/UBESP-DCTV/clumpr)
